...
create_paving("red", "red", "c")
create_paving("blue", "beige", "d")
create_paving("yellow", "tan", "e")
create_paving("green", "beige", "f")
create_paving("purple", "red", "g")
create_paving("brown", "brown", "h")
create_paving("black", "grey", "i")
create_paving("hazard", "tan", "j")
