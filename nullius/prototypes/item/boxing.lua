...
create_boxed_item("turbine-open-1", "fluid-energy", "fbb")
create_boxed_item("turbine-open-2", "fluid-energy", "fcb")
create_boxed_item("turbine-closed-1", "fluid-energy", "fbc")
create_boxed_item("turbine-closed-2", "fluid-energy", "fcc")
...
create_boxed_item("turbine-open-3", "fluid-energy", "fdb")
create_boxed_item("turbine-closed-3", "fluid-energy", "fdc")
...
create_boxed_item("wood", "biology", "db")
create_boxed_item("wood-chip", "biology", "dh")
