...
create_boxed_item("bauxite", "aluminum", "b")
create_boxed_item("crushed-bauxite", "aluminum", "c")
create_boxed_item("aluminum-hydroxide", "aluminum", "d")
create_boxed_item("alumina", "aluminum", "e")
create_boxed_item("aluminum-carbide", "aluminum", "f")
create_boxed_item("aluminum-ingot", "aluminum", "g")
...
create_boxed_item("concrete", "terrain", "d", "concrete")
...
create_boxed_item("aluminum-plate", "aluminum", "h")
create_boxed_item("aluminum-rod", "aluminum", "i")
create_boxed_item("aluminum-sheet", "aluminum", "j")
create_boxed_item("aluminum-wire", "aluminum", "k")
...
create_boxed_item("green-concrete", "concrete", "f")
create_boxed_item("purple-concrete", "concrete", "g")
create_boxed_item("brown-concrete", "concrete", "h")
create_boxed_item("black-concrete", "concrete", "i")
create_boxed_item("hazard-concrete", "concrete", "j", "refined-hazard-concrete")
...
create_boxed_item("power-pole-1", "power-pole", "cb")
create_boxed_item("power-pole-2", "power-pole", "cc")
...
create_boxed_item("backup-turbine-1", "fluid-energy", "dbb")
create_boxed_item("backup-turbine-2", "fluid-energy", "dcb")
create_boxed_item("standard-turbine-1", "fluid-energy", "dbc")
create_boxed_item("standard-turbine-2", "fluid-energy", "dcc")
...
create_boxed_item("copper-ingot", "copper", "e")
create_boxed_item("copper-sheet", "copper", "f")
create_boxed_item("copper-wire", "copper", "g")
