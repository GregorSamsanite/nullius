...
if mods["fcpu"] then
...

	{
		...
		icons = util.technology_icon_constant_stack_size("__stack-inserters__/graphics/technology/transport-belt-capacity.png"),
		effects =
		{
			{
				type = "belt-stack-size-bonus",
	...
	},
	{
		...
		prerequisites = {"nullius-transport-belt-capacity-1"},
		unit =
		{
			count = 5000,
			ingredients =
