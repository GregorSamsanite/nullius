...
if mods["LTN_Combinator_Modernized"] then
	...
	if mods["LogisticTrainNetwork"] then
		table.insert(
			data.raw["technology"]["nullius-logistic-train-network"].effects,
			{ type = "unlock-recipe", recipe = "nullius-ltn-combinator" }
		)
	else
		table.insert(
			data.raw["technology"]["nullius-traffic-control"].effects,
			{ type = "unlock-recipe", recipe = "nullius-ltn-combinator" }
		)
	end
end
...
if mods["miniloader"] then
	...
	if settings.startup["miniloader-enable-standard"].value then
		table.insert(
			data.raw["technology"]["nullius-miniloader-1"].effects,
			{ type = "unlock-recipe", recipe = "nullius-miniloader-1" }
		)
		table.insert(
			data.raw["technology"]["nullius-miniloader-2"].effects,
			{ type = "unlock-recipe", recipe = "nullius-miniloader-2" }
		)
		table.insert(
			data.raw["technology"]["nullius-miniloader-3"].effects,
			{ type = "unlock-recipe", recipe = "nullius-miniloader-3" }
		)
		table.insert(
			data.raw["technology"]["nullius-miniloader-4"].effects,
...
if mods["FluidMustFlow"] then
	...
	if not settings.startup["fmf-enable-duct-auto-join"].value then
		table.insert(
			data.raw["technology"]["nullius-ducts"].effects,
...
if
	mods["beautiful_bridge_railway"]
	or mods["beautiful_bridge_railway_Cargoships"]
	or mods["beautiful_straight_bridge_railway"]
then
	data:extend({
		{
			type = "recipe",
