...
data:extend({
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {mining_time = 0.2, result = "nullius-large-beacon-1"},
    max_health = 800,
    corpse = "medium-remnants",
    dying_explosion = "beacon-explosion",
    collision_box = {{-1.7, -1.7}, {1.7, 1.7}},
    selection_box = {{-2, -2}, {2, 2}},
    collision_mask = {"layer-42", "object-layer", "player-layer", "water-tile"},
    damaged_trigger_effect = data.raw.beacon["beacon"].damaged_trigger_effect,
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {mining_time = 0.2, result = "nullius-large-beacon-2"},
    max_health = 1000,
    corpse = "medium-remnants",
    dying_explosion = "beacon-explosion",
    collision_box = {{-1.7, -1.7}, {1.7, 1.7}},
