...
data:extend({
...

  {
    ...
    weight = 250,
    braking_force = (200 * 1000) / 60, -- 200kW
    friction_force = .0005,
...

  {
    ...
    weight = 300,
    braking_force = (1500 * 1000) / 60, -- 1500kW
    friction_force = .0004,
    rotation_speed = 0.02,
...

  {
    ...
    weight = 4000,
    braking_force = (500 * 1000) / 60, -- 500kW
...

  {
    ...
    turret_return_timeout = 300,
    weight = 5000,
    braking_force = (2000 * 1000) / 60, -- 2MW
