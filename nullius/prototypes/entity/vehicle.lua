data:extend({
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid", "not-flammable"},
    minable = {mining_time = 0.4, result = "nullius-car-2"},
    mined_sound = {filename = "__core__/sound/deconstruct-medium.ogg",volume = 0.8},
    corpse = "car-remnants",
    dying_explosion = "car-explosion",
    alert_icon_shift = util.by_pixel(0, -13),
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid", "not-flammable"},
    minable = {mining_time = 0.4, result = "nullius-car-3"},
    mined_sound = {filename = "__core__/sound/deconstruct-medium.ogg",volume = 0.8},
    corpse = "car-remnants",
    dying_explosion = "car-explosion",
    alert_icon_shift = util.by_pixel(0, -13),
	...
	max_health = 800,
    energy_per_hit_point = 2,
    guns = { "nullius-car-gun", "nullius-car-launcher" },
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid", "not-flammable"},
    minable = {mining_time = 0.5, result = "nullius-truck-1"},
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid", "not-flammable"},
    minable = {mining_time = 0.5, result = "nullius-truck-2"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg",volume = 0.8},
    corpse = "tank-remnants",
    dying_explosion = "tank-explosion",
    alert_icon_shift = util.by_pixel(0, -13),
...

  {
	...
	minable = {mining_time = 1, result = "nullius-mecha"},
    ...
    equipment_grid = "nullius-mecha-grid",
    height = 1.5,
...

  {
	...
	minable = {mining_time = 1, result = "nullius-mecha-2"},
    collision_box = {{-1 * 1, -1 * 1}, {1 * 1, 1 * 1}},
    sticker_box = {{-1.5 * 1, -1.5 * 1}, {1.5 * 1, 1.5 * 1}},
    selection_box = {{-1 * 1, -1 * 1}, {1 * 1, 1 * 1}},
    drawing_box = {{-3 * 1, -4 * 1}, {3 * 1, 2 * 1}},
...

  {
    ...
    minable = {mining_time = 1, result = "nullius-silo"},
    max_health = 5000,
