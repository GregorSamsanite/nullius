data:extend({
...

  {
    ...
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {mining_time = 0.2, result = "nullius-small-furnace-2"},
    max_health = 250,
...
data:extend({
...

  {
    ...
    minable = {mining_time = 1, result = "nullius-foundry-1"},
    ...
    vehicle_impact_sound =  { filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65 },
    working_sound = data.raw["assembling-machine"]["casting-machine"].working_sound
  }
})
...
data:extend({
...

  {
    ...
    flags = {"placeable-neutral", "player-creation"},
    minable = {mining_time = 1, result = "nullius-foundry-3"},
    fast_replaceable_group = "foundry",
    max_health = 500,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
