data:extend({
  {
    ...
    minable = {mining_time = 0.5, result = "nullius-locomotive-1"},
...
data:extend({
  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    minable = {mining_time = 0.5, result = "nullius-locomotive-2"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg", volume = 0.8},
    max_health = 1000,
    corpse = "locomotive-remnants",
    dying_explosion = "locomotive-explosion",
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    minable = {mining_time = 0.5, result = "nullius-locomotive-3"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg", volume = 0.8},
    max_health = 1500,
    corpse = "locomotive-remnants",
    dying_explosion = "locomotive-explosion",
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    minable = {mining_time = 0.5, result = "nullius-solar-locomotive"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg", volume = 0.8},
    max_health = 1500,
    corpse = "locomotive-remnants",
    dying_explosion = "locomotive-explosion",
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    inventory_size = 25,
    minable = {mining_time = 0.5, result = "nullius-cargo-wagon-1"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg",volume = 0.8},
    max_health = 400,
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    inventory_size = 50,
    minable = {mining_time = 0.5, result = "nullius-cargo-wagon-2"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg",volume = 0.8},
    max_health = 600,
    corpse = "cargo-wagon-remnants",
    dying_explosion = "cargo-wagon-explosion",
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    inventory_size = 100,
    minable = {mining_time = 0.5, result = "nullius-cargo-wagon-3"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg", volume = 0.8},
    max_health = 800,
    corpse = "cargo-wagon-remnants",
    dying_explosion = "cargo-wagon-explosion",
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    minable = {mining_time = 0.5, result = "nullius-fluid-wagon-1"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg",volume = 0.8},
    max_health = 500,
    capacity = 25000,
...
data:extend({
  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    minable = {mining_time = 0.5, result = "nullius-fluid-wagon-2"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg",volume = 0.8},
    max_health = 750,
    capacity = 50000,
    corpse = "fluid-wagon-remnants",
...

  {
    ...
    flags = {"placeable-neutral", "player-creation", "placeable-off-grid"},
    minable = {mining_time = 0.5, result = "nullius-fluid-wagon-3"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg", volume = 0.8},
    max_health = 1000,
    capacity = 100000,
    corpse = "fluid-wagon-remnants",
...

  {
    ...
    inventory_size = 3,
    ammo_stack_limit = 10,
    minable = {mining_time = 0.5, result = "nullius-drone-carrier-1"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg", volume = 0.8},
    max_health = 800,
...

  {
    ...
    inventory_size = 5,
    ammo_stack_limit = 10,
    minable = {mining_time = 0.5, result = "nullius-drone-carrier-2"},
    mined_sound = {filename = "__core__/sound/deconstruct-large.ogg", volume = 0.8},
    max_health = 1000,
    corpse = "artillery-wagon-remnants",
    dying_explosion = "artillery-wagon-explosion",
