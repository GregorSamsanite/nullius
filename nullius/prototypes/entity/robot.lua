data:extend({
...

  {
	...
	localised_description = {"entity-description.logistic-robot"},
...

  {
    ...
    minable = {mining_time = 0.3, result = "nullius-hangar-1"},
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {mining_time = 0.3, result = "nullius-hangar-2"},
	fast_replaceable_group = "nullius-hangar",
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {mining_time = 0.3, result = "nullius-hangar-3"},
	fast_replaceable_group = "nullius-hangar",
    max_health = 600,
    corpse = "roboport-remnants",
    dying_explosion = "roboport-explosion",
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {mining_time = 0.2, result = "nullius-hangar-4"},
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.1, result = "nullius-relay-1"},
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.1, result = "nullius-relay-2"},
    fast_replaceable_group = "nullius-relay",
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.2, result = "nullius-charger-1"},
    fast_replaceable_group = "nullius-charger",
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.2, result = "nullius-charger-2"},
    fast_replaceable_group = "nullius-charger",
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.2, result = "nullius-charger-3"},
    fast_replaceable_group = "nullius-charger",
    max_health = 200,
    corpse = "medium-remnants",
    collision_box = {{-0.7, -0.7}, {0.7, 0.7}},
...

  {
    ...
    flags = {"placeable-player", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.1, result = "nullius-charger-4"},
    max_health = 200,
    corpse = "medium-remnants",
    collision_box = {{-0.2, -0.2}, {0.2, 0.2}},
    selection_box = {{-0.5, -0.5}, {0.5, 0.5}},
