...
local solar_values = {
  { ratio = 9.01667, maxtemp = 200, threshold = 50 },
  { ratio = 7.21334, maxtemp = 300, threshold = 100 },
  { ratio = 6.01112, maxtemp = 400, threshold = 150 }  
}

function update_solar()
  if (global.nullius_solar_buckets == nil) then return end
  local bucket = global.nullius_solar_buckets[game.tick % 541]
