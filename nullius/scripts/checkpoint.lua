...
local checkpoint_data = {
  ...
  ["propene"] = {{ CHK_FLUID, STT_CONSUME, 400000, {{"nullius-propene"}} }},
  ...
  ["crushed-iron-ore"] = {{ CHK_ITEM, STT_CONSUME, 50000, {{"nullius-crushed-iron-ore"}} }},
  ["aluminum-carbide"] = {{ CHK_ITEM, STT_CONSUME, 50000, {{"nullius-aluminum-carbide"}} }},
  ...
  ["explosive"] = {{ CHK_ITEM, STT_CONSUME, 30, {{"cliff-explosives"}} }},
